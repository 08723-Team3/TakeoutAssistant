...
static NSString * const kConsumerKey       = @"4mCltr6EkIFMMKXSmI9ZAA";
static NSString * const kConsumerSecret    = @"uGn5WulOb_I5Pr240iIAHhcwBBw";
static NSString * const kToken             = @"Bkk5g_dMo18B5e0kepfC7rqdtQC1Vmtw";
static NSString * const kTokenSecret       = @"UkG5Ep-JEQwTm958KPD2-oP6HqM";
